                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row mb-2">
                                ...
                                <div class="col-md-6 text-end"><a href="{{ route('client:create') }}"
                                        class="btn btn-primary">Add New Account</a></div>
                            </div>
                            <div class="table-responsive">
                                <table id="client-table" class="table table-striped" data-toggle="data-table">
                                    <thead>
                                        <tr>
                                        ...
                                        @foreach ($clients as $client)
                                            <tr>
                                                <td>
                                                    ...
                                                    @else
                                                        <img src="{{ asset('project_images/client/' . $client->image) }}"
                                                            alt="{{ Str::title($client->name) }}"
                                                            class="theme-color-default-img img-fluid avatar avatar-50 avatar-rounded">
                                                    @endif
                                                ...
                                                <td>
                                                    <a class="btn btn-sm btn-icon btn-success" data-bs-toggle="tooltip"
                                                        ...
                                                        href="{{ route('client:view', $client->client_id) }}"
                                                        target="_blank">
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $(document).on("submit", "#invitation_status", function(e) {
                            ...
                            $.ajax({
                                url: "{{ route('client:update_status') }}",
                                type: 'POST',
                                data: formData,
                                processData: false,
                                contentType: false,

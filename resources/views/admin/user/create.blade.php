                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="new-user-info">
                                    <form id="add_user_form" class="create-user">
                                        @csrf
                                        <div class="add_user_notify"></div>
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <input type="text" class="form-control" id="email"
                                                    name="email" placeholder="User Name">
                                            </div>
                                        ...
                                        <button type="submit" class="btn btn-primary float-end"
                                            id="add_user_btn">Add New User</button>
                                    </form>
                                </div>
                            </div>
                        </div>
            ...
            $(".create-user").validate({
                ...
                messages: {
                    ...
                    contact: {
                        ...
                        minlength: "Password must be at least 11 characters"
                    },
                    description: {

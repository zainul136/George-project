                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row mb-2">
                                ...
                                <div class="col-md-6 text-end"><a href="{{ route('admin:create') }}"
                                        class="btn btn-primary">Add New Account</a></div>
                            </div>
                            <div class="table-responsive">
                                <table id="admins-table" class="table table-striped" data-toggle="data-table">
                                    <thead>
                                        <tr>
                                        ...
                                        @foreach ($admins as $admin)
                                            <tr>
                                                <td>
                                                    ...
                                                    @else
                                                        <img src="{{ asset('project_images/admin/' . $admin->image) }}"
                                                            alt="{{ Str::title($admin->name) }}"
                                                            class="theme-color-default-img img-fluid avatar avatar-50 avatar-rounded">
                                                    @endif
                                                </td>
                                                <td>{{ $admin->name }}</td>
                                                ...
                                                <td>
                                                    <a class="btn btn-sm btn-icon btn-success" data-bs-toggle="tooltip"
                                                        ...
                                                        href="{{ route('admin:view', $admin->admin_id) }}"
                                                        target="_blank">
                                                    ...
                                                    <a class="btn btn-sm btn-icon btn-warning"
                                                        href="{{ route('admin:edit', $admin->admin_id) }}"
        ...
        $(".change_status").click(function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    let admin_id = response.admin_id;
                    ...
                    // Update Status
                    $(document).on("submit", "#admin_status", function(e) {
                        e.preventDefault();

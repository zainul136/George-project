...
<body class="  ">
            ...
            <div>
                <div class="row">
                    <div class="col-xl-12 col-lg-12">
                        <form id="add_contractor_form" class="create-contractor">
                            @csrf
                                    ...
                                    <div class="new-contractor-info">
                                        <div class="row mb-2">
                                            <div class="col-md-6 text-start">
                                                <h4 class="card-title">Add New Contractor</h4>
                                            </div>
                                            <div class="col-md-6 text-end"><a href="{{ route('contractor:list') }}"
                                                    class="btn btn-primary">View All Contractors</a></div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-2">
                                                <img id="c_cons_image"
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select name="projects[]"
                                                            ...
                                                            @if (count($projects) > 0)
                                                                ...
                                                                @endforeach
                                                            @else
                                                                <option disabled>Project Not Available</option>
                                                            @endif
                                                        </select>
                                                    </div>
                                                    <div class="form-group col-md-6">
                                            ...
                                            <div class="add_contractor_notify"></div>
                                            <div class="card-footer">
                                                <button type="submit" class="btn btn-primary float-end"
                                                    id="add_contractor_btn">Add
                                                    Contractor</button>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script>
        $(document).ready(function() {
            $(document).on("submit", "#add_contractor_form", function(e) {
                e.preventDefault();

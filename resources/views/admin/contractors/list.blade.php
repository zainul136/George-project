    ...
    <main class="main-content">
        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <form id="contractor_status">
                    @csrf
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Contractor Status</h5>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row mb-2">
                                ...
                                <div class="col-md-6 text-end"><a href="{{ route('contractor:create') }}"
                                        class="btn btn-primary">Add New Account</a></div>
                            </div>
                            <div class="table-responsive">
                                <table id="contractor-table" class="table table-striped" data-toggle="data-table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-uppercase">Projects</th>
                                        ...
                                        @foreach ($contractors as $contractor)
                                            <tr>
                                                <td>
                                                    ...
                                                    @else
                                                        <img src="{{ asset('project_images/contractor/' . $contractor->image) }}"
                                                            alt="{{ Str::title($contractor->name) }}"
                                                            class="theme-color-default-img img-fluid avatar avatar-50 avatar-rounded">
                                                    @endif
                                                </td>
                                                ...
                                                <td>
                                                    @foreach ($projects as $project)
                                                        @if (in_array($project->project_id, explode(',', $contractor->project)))
                                                            <option
                                                                value="{{ $project->project_id }}"{{ in_array($project->project_id, explode(',', $contractor->project)) }}>
                                                                <span class="badge bg-success">{{ $project->name }}</span>
                                                            </option>
                                                        @endif
                                                    @endforeach
                                                </td>
                                                ...
                                                <td>
                                                    <a class="btn btn-sm btn-icon btn-success" data-bs-toggle="tooltip"
                                                        ...
                                                        href="{{ route('contractor:view', $contractor->contractor_id) }}">
                                                    ...
                                                    <a class="btn btn-sm btn-icon btn-warning"
                                                        href="{{ route('contractor:edit', $contractor->contractor_id) }}"
            ...
            $(".change_status").click(function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        let contractor_id = response.contractor_id;
                        let status = response.status;
                        $("#code").val(contractor_id);
                        if (status == 1) {
                        ...
                        // Update Status
                        $(document).on("submit", "#contractor_status", function(e) {
                            e.preventDefault();
                            let formData = new FormData(this);
                            $.ajax({
                                url: "{{ route('contractor:update_status') }}",
                                type: 'POST',
                                data: formData,
                                processData: false,
                                contentType: false,
